...
echo -e "${GREEN}======================================================${NC}"
echo -e "👉 ${CYAN}Frontend UI       :${NC} http://localhost:4001"
echo -e "👉 ${CYAN}Backend REST API  :${NC} http://localhost:8081/api/users"
echo -e "👉 ${CYAN}PostgreSQL DB     :${NC} localhost:5001 (DB: fooddelivery01)"
echo -e "${GREEN}======================================================${NC}"
